<!-- Begin Page Content -->
<div id="label-page">
	<h2>Tampil Data Transaksi Peminjaman</h2>
</div>
<div id="content">
									...
									<tr>
										...
										<td>
											<div class="btn-group-md">
												<a target="_blank" href="pages/cetak-info-transaksi-peminjaman.php?id=<?php echo $r_tampil_transaksi['idtransaksi']; ?>" class="badge badge-info"><i class="fas fa-fw fa-book"></i> Cetak Info Transaksi</a><br>
